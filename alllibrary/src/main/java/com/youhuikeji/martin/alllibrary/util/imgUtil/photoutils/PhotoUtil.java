package com.youhuikeji.martin.alllibrary.util.imgUtil.photoutils;
...
import com.youhuikeji.martin.alllibrary.util.imgUtil.photoutils.activity.PhotoSelectActivity;
import com.youhuikeji.martin.alllibrary.view.ActionSheet;
...
public class PhotoUtil {
    ...
    /*          case CODE_REQUEST_PICK_BASE:
                    String headPath = data.getStringExtra("imgPath");
                    ImageManager.getInstance().loadLocalImage(this, headPath, img);
                    break;
                case CODE_REQUEST_TAKE_BASE:
                    String path = mOut.getPath();
                    ImageManager.getInstance().loadLocalImage(this, path, img);
                    break;*/
