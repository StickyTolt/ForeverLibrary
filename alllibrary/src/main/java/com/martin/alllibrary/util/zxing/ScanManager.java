...
import com.martin.alllibrary.util.zxing.camera.CameraManager;
import com.martin.alllibrary.util.zxing.decode.DecodeThread;
import com.martin.alllibrary.util.zxing.decode.PhotoScanHandler;
import com.martin.alllibrary.util.zxing.decode.RGBLuminanceSource;
import com.martin.alllibrary.util.zxing.utils.BeepManager;
import com.martin.alllibrary.util.zxing.utils.BitmapUtil;
import com.martin.alllibrary.util.zxing.utils.CaptureActivityHandler;
import com.martin.alllibrary.util.zxing.utils.InactivityTimer;
...
public class ScanManager implements SurfaceHolder.Callback {
     ...
     */
    public ScanManager(Activity activity, ScanListener listener, int scanMode) {
        this.activity = activity;
        this.listener = listener;
        this.scanMode = scanMode;
    }
