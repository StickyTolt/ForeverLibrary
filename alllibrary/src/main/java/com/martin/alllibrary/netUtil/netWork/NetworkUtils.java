package com.martin.alllibrary.netUtil.netWork;
...
public class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        ToolCache.getContext().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS)
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager cm = (ConnectivityManager) ToolCache.getContext()
    ...
    public static boolean getDataEnabled() {
        try {
            TelephonyManager tm = (TelephonyManager) ToolCache.getContext().getSystemService(Context.TELEPHONY_SERVICE);
